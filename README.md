...
- You can view the panel that displays the artifacts that have already been added to the artifact collection by clicking the "Show All" button.
...
- You can generate the second required action related to the user story "find all 5-star artifacts in my artifact collection" by clicking the "⭐️⭐️⭐️⭐️⭐️" button to display all five-star artifacts.
